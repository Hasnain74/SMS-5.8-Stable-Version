...
<div class="page" style="width:1200px; margin-left: -50px;">
...
<main>
    <table>
        ...
        <tr>
            ...
            <td style="font-weight: bold;" class="total">RS {{$inv->total_payable_fee}}</td>
        </tr>
        <tr>
            <td style="font-weight: bold;" class="total" class="last_total" colspan="4">Paid Fee</td>
        ...
        <tr>
            <td style="font-weight: bold;" colspan="4" class="grand total">Remaining Fee</td>

...
<header class="clearfix">
    @foreach($reports as $date => $salary_group)
        ...
        <div id="project">
            <div><span>Paid Students</span> &nbsp;&nbsp;{{count($salary_group)}}</div>
            <div><span>Total Amount</span>&nbsp;&nbsp; {{$total}}</div>
            <div><span>Date</span>&nbsp;&nbsp; {{date('F, Y', strtotime($salary->paid_date))}}</div>
        </div>
</header>
<main>
    <table>
        <thead>
        <tr>
            <th class="service">Students Names</th>
            <th></th>
            <th></th>
            <th></th>
        ...
        @foreach($report as $s)
            <tbody>
            <tr>
                <td class="service">{{$s->student_name}}</td>
                <td class="desc"></td>
                <td class="unit"></td>
                <td class="qty"></td>
